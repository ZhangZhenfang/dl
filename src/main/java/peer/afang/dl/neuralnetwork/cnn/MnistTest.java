...
public class MnistTest {
    ...
    public static void main(String[] args) {
        Mat[] inputs = new Mat[20000];
        Mat[] labels = new Mat[20000];
...
//                b4 = b4 - rate * MatUtils.sumMat(delta4);
            ...
            Mat[] testInputs = new Mat[500];
            Mat[] testLabels = new Mat[500];
...
//            Mat z4 = new Mat();
                ...
                int predict = Utils.maxIndex(a6);
                int real= Utils.maxIndex(testLabels[i]);
                if (predict == real) {
                    correct++;
                } else {
                    error++;
            ...
            System.out.println((double) correct / (correct + error));
        }
